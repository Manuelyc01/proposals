...
public class ApxListProcessTasksProposalsMapperTest {
    ...
    private IApxIProcessTasksProposalsMapper mapper;

    @Before
    public void setUp(){
        mapper = new ApxListProcessTasksProposalsMapper();
    }
    ...
    public void mapOutEmptyTest() throws IOException{
        ...
        ProcessTasks result= mapper.mapOut(new RespuestaTransaccionPpcutge1_1());
